...
if (${HDF5_PACKAGE_NAME}_BUILD_JAVA)
  set (${HDF5_PACKAGE_NAME}_JAVA_INCLUDE_DIRS
      ${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/lib/jarhdf5-1.14.3.jar
      ${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/lib/slf4j-api-2.0.6.jar
      ${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/lib/slf4j-nop-2.0.6.jar
  )
  set (${HDF5_PACKAGE_NAME}_JAVA_LIBRARY "${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/lib")
...
set (${HDF5_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/cmake")
set_and_check (${HDF5_PACKAGE_NAME}_BUILD_DIR "${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3")
...
if (${HDF5_PACKAGE_NAME}_BUILD_TOOLS)
  ...
  set_and_check (${HDF5_PACKAGE_NAME}_TOOLS_DIR "${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/bin")
endif ()

#-----------------------------------------------------------------------------
# Version Strings
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_VERSION_STRING 1.14.3)
set (${HDF5_PACKAGE_NAME}_VERSION_MAJOR  1.14)
set (${HDF5_PACKAGE_NAME}_VERSION_MINOR  3)
...
if (NOT TARGET "hdf5")
  if (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS)
    include (${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/cmake/zlib-targets.cmake)
  endif ()
  if (${HDF5_PACKAGE_NAME}_ENABLE_SZIP_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS)
    include (${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/cmake/libaec-targets.cmake)
  endif ()
  include (${PACKAGE_PREFIX_DIR}/%ProgramFiles%/HDF_Group/HDF5/1.14.3/cmake/hdf5-targets.cmake)
endif ()
